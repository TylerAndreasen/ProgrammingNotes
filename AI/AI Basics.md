...
Briefly, I am not personally highly interested in LLM tools, they can be helpful in (what are for me) narrow situations (as I currently avoid simply using them to pump out simple code), mostly finding terminology or tools that search engines may not find.
I am interested in mimicing projects like Code Bullet for my own learning, but I eventually want to write suffecient scripts in Papyrus (and likely other things for effeciency) to let Skyrim learn to play itself.
